@smoketest
  Feature: Проведение платежей через виртуальный терминал
    ...
    Scenario: Совершение MOTO - платежа
      ...
      And ввести в поле с именем "Комментарии" текст: "motopay smoke test" в "Раздел виртуального терминала (MOTO - платеж)"
    ...
    Scenario: Совершение POS - платежа
      ...
      And ввести в поле с именем "Комментарии" текст: "pospay smoke test" в "Раздел виртуального терминала (POS - платеж)"
